...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and 
        ( (results_stats_dic.get('n_correct_dogs',0) + results_stats_dic.get('n_correct_notdogs',0)
    ...
    if (print_incorrect_breed and 
        (results_stats_dic.get('n_correct_dogs',0) != results_stats_dic.get('n_correct_breed', 0) 
       )):
